...
const news = [
    {id: 1, title: 'News1', body:'Lizards are a widespread group of squamate reptiles, with over 6,000\n' +
    ...
    {id: 2, title: 'News2', body:'Lizards are a widespread group of squamate reptiles, with over 6,000\n' +
'species, ranging across all continents except Antarctica with ranging across all continents except Antarctica', img:'cover_2', views: 132, likes: 90, liked: true, width: 3},
    {id: 3, title: 'News3', body:'Lizards are a widespread group of squamate reptiles, with over 6,000\n' +
    ...
    {id: 4, title: 'News4', body:'Lizards are a widespread group of squamate reptiles, with over 6,000\n' +
    ...
    {id: 5, title: 'News5', body:'Lizards are a widespread group of squamate reptiles, with over 6,000\n' +
    ...
    {id: 6, title: 'News6', body:'Lizards are a widespread group of squamate reptiles, with over 6,000\n' +
    ...
    {id: 7, title: 'News7', body:'Lizards are a widespread group of squamate reptiles, with over 6,000\n' +
